...
namespace ICEDT_TamilApp.Application.Services.Implementation
{
    public class ProgressService : IProgressService
    {
        ...
        public ProgressService(IProgressRepository progressRepository, IActivityRepository activityRepository, ILessonRepository lessonRepository)
        {
        ...
        public async Task<ActivityCompletionResponseDto> CompleteActivityAsync(int userId, ActivityCompletionRequestDto request)
        {
            ...
            if (activity == null)
            {
                throw new NotFoundException($"Activity with ID {request.ActivityId} and name {nameof(activity)}not found.");
            }
